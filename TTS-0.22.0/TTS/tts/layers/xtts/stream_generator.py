...
# BeamSearchScorer and friends moved in newer transformers versions
try:
    from transformers import (
        BeamSearchScorer,
    ...
    try:
        ...
        # Stub out — streaming beam search won't work but basic inference will
...
try:
    ...
    SampleOutput = GenerateOutput  # alias for newer versions
